...
const UserDetail = () => {
  ...
  return (
    <div>
        ...
        <label className="input input-bordered flex items-center gap-2">
            Phone
            <input type="text" value={state.phone} placeholder="Type here" className="input input-ghost w-full max-w-xs" />
        </label>
        <label className="input input-bordered flex items-center gap-2">
            Country
            <input type="text" value={state.city} placeholder="Type here" className="input input-ghost w-full max-w-xs" />
        </label>
        <label className="input input-bordered flex items-center gap-2">
            Balance
